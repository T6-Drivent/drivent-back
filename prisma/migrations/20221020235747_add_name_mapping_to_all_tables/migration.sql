...
-- DropForeignKey
ALTER TABLE "Event" DROP CONSTRAINT "Event_pricingId_fkey";
...
-- CreateIndex
CREATE UNIQUE INDEX "events_priceId_key" ON "events"("priceId");
...
-- AddForeignKey
ALTER TABLE "events" ADD CONSTRAINT "events_priceId_fkey" FOREIGN KEY ("priceId") REFERENCES "prices"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
